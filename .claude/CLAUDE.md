...
When you drive a multi-step piece of work through subagents, load the
`orchestration` skill first. It holds the roles, the brief format, the control
loop and the completion rules.
