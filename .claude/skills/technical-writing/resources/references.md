...
- Paul Hammond (citypaul), dotfiles technical-writing skill — https://github.com/citypaul/.dotfiles/tree/main/claude/.claude/skills/technical-writing (the version this skill was ported from)
